...
return s?$(s):b.eq(-1);}function k(s){return"translate(0, "+s+"px)";}function f(s){s=s*0.5+0.5;return"scale("+s+")";}var l=false;var r;var i;var p;function g(){clearTimeout(p);
...
var m=document.getElementById("media");var h=$("#audio_btn");m.src="image/bg-music.mp3";$(m).on("play",function(){h.removeClass("audio_off").addClass("audio_play");
